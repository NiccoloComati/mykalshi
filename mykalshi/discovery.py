...
def _search_market_page_predicate(
    market_item: dict[str, Any],
    *,
    market_ticker_contains: str | None,
    market_title_contains: str | None,
    subtitle_contains: str | None,
) -> bool:
    return (
...
def search_series(
    *,
    ...
    if ticker is not None and ticker_contains is None and title_contains is None and tag_contains is None:
    ...
    if use_event_scope:
        ...
        for event_item in event_items:
            ...
            market_items = _collect_filtered_pages(
                ...
                item_key="markets",
                predicate=lambda market_item: _search_market_page_predicate(
                    market_item,
